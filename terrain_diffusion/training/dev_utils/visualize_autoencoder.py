...
class AutoencoderVisualizer:
    ...
    def update_display(self):
        ...
        recon_channel_types = ['residual', 'water_logits']  # For reconstructions
...
def main(model_path, config, batch_size, device, num_workers):
    ...
    visualizer = AutoencoderVisualizer(model, dataloader, device)
    visualizer.show()
