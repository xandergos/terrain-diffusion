...
@click.option('--experiment-name', type=str, default='infinite_consistency_onestep', help='Name of experiment folder in results/')
def main(model_path, config_path, num_images, batch_size, decoder_batch_size, metric, decoder_inter_t, weight_window_fn, save_images, experiment_name):
    """Evaluate 1-step base consistency model using FID/KID on decoded terrain."""
    build_registry()
    ...
    with torch.no_grad(), accelerator.autocast():
        while pbar.n < pbar.total:
            ...
            with accelerator.autocast():
                ...
                # 1-step sampling: single pass over all tiles
                ...
                for ic, i0 in enumerate(h_starts):
                    for jc, j0 in enumerate(w_starts):
                        ...
                        x_t = torch.sin(t) * z  # No previous sample for 1-step
